...
public class ComboBoxCountry extends JPanel implements ActionListener {
	...
	//	numCountries = 1; //Overrides the above to only allow selection of Italy
		...
		countryList.setSelectedIndex(Country.PL.ordinal());
	...
	protected void updateLabel(String countryName) {
		Country country = Country.PL.getCountryFromNameString(countryName);
	 ...
	 *
	 */
	public Country getCountryEnum() { return Country.PL.getCountryFromNameString(this.countryName); }
}
